(define   (problem parking)
  ...
  (:init
    (at_curb car_16)
    (at_curb_num car_16 curb_00)
    (behind_car car_09 car_16)
    (car_clear car_09)
    (at_curb car_24)
    (at_curb_num car_24 curb_01)
    (behind_car car_22 car_24)
    (car_clear car_22)
    (at_curb car_08)
    (at_curb_num car_08 curb_02)
    (behind_car car_14 car_08)
    (car_clear car_14)
    (at_curb car_23)
    (at_curb_num car_23 curb_03)
    (behind_car car_21 car_23)
    (car_clear car_21)
    (at_curb car_19)
    (at_curb_num car_19 curb_04)
    (behind_car car_12 car_19)
    (car_clear car_12)
    (at_curb car_01)
    (at_curb_num car_01 curb_05)
    (behind_car car_03 car_01)
    (car_clear car_03)
    (at_curb car_05)
    (at_curb_num car_05 curb_06)
    (behind_car car_17 car_05)
    (car_clear car_17)
    (at_curb car_07)
    (at_curb_num car_07 curb_07)
    (behind_car car_15 car_07)
    (car_clear car_15)
    (at_curb car_10)
    (at_curb_num car_10 curb_08)
    (behind_car car_20 car_10)
    (car_clear car_20)
    (at_curb car_25)
    (at_curb_num car_25 curb_09)
    (behind_car car_06 car_25)
    (car_clear car_06)
    (at_curb car_11)
    ...
    (behind_car car_18 car_00)
    (car_clear car_18)
    (at_curb car_02)
    (at_curb_num car_02 curb_12)
    (behind_car car_13 car_02)
    (car_clear car_13)
    (curb_clear curb_13)
  )
  (:goal
