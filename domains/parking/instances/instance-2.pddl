(define   (problem parking)
  ...
  (:init
    (at_curb car_20)
    (at_curb_num car_20 curb_00)
    (behind_car car_13 car_20)
    (car_clear car_13)
    (at_curb car_12)
    (at_curb_num car_12 curb_01)
    (behind_car car_15 car_12)
    (car_clear car_15)
    (at_curb car_10)
    (at_curb_num car_10 curb_02)
    (behind_car car_05 car_10)
    (car_clear car_05)
    (at_curb car_09)
    (at_curb_num car_09 curb_03)
    (behind_car car_18 car_09)
    (car_clear car_18)
    (at_curb car_14)
    (at_curb_num car_14 curb_04)
    (behind_car car_06 car_14)
    (car_clear car_06)
    (at_curb car_19)
    (at_curb_num car_19 curb_05)
    (behind_car car_11 car_19)
    (car_clear car_11)
    (at_curb car_02)
    (at_curb_num car_02 curb_06)
    (behind_car car_16 car_02)
    (car_clear car_16)
    (at_curb car_07)
    (at_curb_num car_07 curb_07)
    (behind_car car_17 car_07)
    (car_clear car_17)
    (at_curb car_08)
    ...
    (car_clear car_00)
    (at_curb car_01)
    (at_curb_num car_01 curb_09)
    (behind_car car_03 car_01)
    (car_clear car_03)
    (at_curb car_21)
    (at_curb_num car_21 curb_10)
