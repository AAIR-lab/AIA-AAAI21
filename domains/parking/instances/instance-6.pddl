(define   (problem parking)
  ...
  (:init
    ...
    (behind_car car_07 car_21)
    (car_clear car_07)
    (at_curb car_01)
    (at_curb_num car_01 curb_02)
    (behind_car car_19 car_01)
    (car_clear car_19)
    (at_curb car_18)
    (at_curb_num car_18 curb_03)
    (behind_car car_06 car_18)
    (car_clear car_06)
    (at_curb car_02)
    (at_curb_num car_02 curb_04)
    (behind_car car_23 car_02)
    (car_clear car_23)
    (at_curb car_14)
    (at_curb_num car_14 curb_05)
    (behind_car car_08 car_14)
    (car_clear car_08)
    (at_curb car_11)
    (at_curb_num car_11 curb_06)
    (behind_car car_13 car_11)
    (car_clear car_13)
    (at_curb car_09)
    (at_curb_num car_09 curb_07)
    (behind_car car_22 car_09)
    (car_clear car_22)
    (at_curb car_12)
    (at_curb_num car_12 curb_08)
    (behind_car car_15 car_12)
    (car_clear car_15)
    (at_curb car_04)
    (at_curb_num car_04 curb_09)
    (behind_car car_03 car_04)
    (car_clear car_03)
    (at_curb car_16)
    (at_curb_num car_16 curb_10)
    (behind_car car_05 car_16)
    (car_clear car_05)
    (at_curb car_10)
    (at_curb_num car_10 curb_11)
    (car_clear car_10)
    (at_curb car_17)
    (at_curb_num car_17 curb_12)
    (car_clear car_17)
  )
  (:goal
    (and
