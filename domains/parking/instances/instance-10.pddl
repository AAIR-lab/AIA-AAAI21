(define   (problem parking)
  ...
  (:init
    ...
    (behind_car car_18 car_21)
    (car_clear car_18)
    (at_curb car_17)
    (at_curb_num car_17 curb_01)
    (behind_car car_14 car_17)
    (car_clear car_14)
    (at_curb car_15)
    (at_curb_num car_15 curb_02)
    (behind_car car_03 car_15)
    (car_clear car_03)
    (at_curb car_01)
    (at_curb_num car_01 curb_03)
    (behind_car car_10 car_01)
    (car_clear car_10)
    (at_curb car_11)
    (at_curb_num car_11 curb_04)
    (behind_car car_16 car_11)
    (car_clear car_16)
    (at_curb car_05)
    ...
    (car_clear car_19)
    (at_curb car_04)
    (at_curb_num car_04 curb_06)
    (behind_car car_06 car_04)
    (car_clear car_06)
    (at_curb car_00)
    (at_curb_num car_00 curb_07)
    (behind_car car_20 car_00)
    (car_clear car_20)
    (at_curb car_07)
    (at_curb_num car_07 curb_08)
    (behind_car car_23 car_07)
    (car_clear car_23)
    (at_curb car_02)
    (at_curb_num car_02 curb_09)
    (behind_car car_12 car_02)
    (car_clear car_12)
    (at_curb car_09)
    (at_curb_num car_09 curb_10)
    (behind_car car_25 car_09)
    (car_clear car_25)
    (at_curb car_24)
    (at_curb_num car_24 curb_11)
    (behind_car car_22 car_24)
    (car_clear car_22)
    (at_curb car_13)
    (at_curb_num car_13 curb_12)
    (behind_car car_08 car_13)
    (car_clear car_08)
    (curb_clear curb_13)
  )
  (:goal
