(define   (problem parking)
  ...
  (:init
    (at_curb car_05)
    (at_curb_num car_05 curb_00)
    (behind_car car_17 car_05)
    (car_clear car_17)
    (at_curb car_11)
    (at_curb_num car_11 curb_01)
    (behind_car car_23 car_11)
    (car_clear car_23)
    (at_curb car_12)
    (at_curb_num car_12 curb_02)
    (behind_car car_03 car_12)
    (car_clear car_03)
    (at_curb car_20)
    (at_curb_num car_20 curb_03)
    ...
    (behind_car car_21 car_00)
    (car_clear car_21)
    (at_curb car_01)
    (at_curb_num car_01 curb_10)
    (behind_car car_15 car_01)
    (car_clear car_15)
    (at_curb car_06)
    (at_curb_num car_06 curb_11)
    (car_clear car_06)
    (at_curb car_16)
    (at_curb_num car_16 curb_12)
    (car_clear car_16)
  )
  (:goal
    (and
