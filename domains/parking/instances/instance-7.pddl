(define   (problem parking)
  ...
  (:init
    (at_curb car_13)
    (at_curb_num car_13 curb_00)
    (behind_car car_03 car_13)
    (car_clear car_03)
    (at_curb car_21)
    (at_curb_num car_21 curb_01)
    (behind_car car_06 car_21)
    (car_clear car_06)
    (at_curb car_01)
    ...
    (car_clear car_08)
    (at_curb car_15)
    (at_curb_num car_15 curb_03)
    (behind_car car_07 car_15)
    (car_clear car_07)
    (at_curb car_16)
    (at_curb_num car_16 curb_04)
    (behind_car car_10 car_16)
    (car_clear car_10)
    (at_curb car_05)
    (at_curb_num car_05 curb_05)
    (behind_car car_02 car_05)
    (car_clear car_02)
    (at_curb car_11)
    (at_curb_num car_11 curb_06)
    (behind_car car_19 car_11)
    (car_clear car_19)
    (at_curb car_18)
    (at_curb_num car_18 curb_07)
    (behind_car car_17 car_18)
    (car_clear car_17)
    (at_curb car_25)
    (at_curb_num car_25 curb_08)
    (behind_car car_24 car_25)
    (car_clear car_24)
    (at_curb car_22)
    (at_curb_num car_22 curb_09)
    (behind_car car_23 car_22)
    (car_clear car_23)
    (at_curb car_09)
    (at_curb_num car_09 curb_10)
    (behind_car car_20 car_09)
    (car_clear car_20)
    (at_curb car_00)
    ...
    (car_clear car_14)
    (at_curb car_04)
    (at_curb_num car_04 curb_12)
    (behind_car car_12 car_04)
    (car_clear car_12)
    (curb_clear curb_13)
  )
  (:goal
